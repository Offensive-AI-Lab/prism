            ...
            if generate:
                out = model.generate(
                    **tokenized,
                    ...
                    # Qwen3 family: model.generation_config.eos_token_id is
                    # <|endoftext|>, but tokenizer.eos_token_id is the chat
                    # turn-end <|im_end|>. Without this, generate() runs past
                    # the first <|im_end|> and synthesizes additional turns.
